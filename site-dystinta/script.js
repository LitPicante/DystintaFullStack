const DEFAULT_DATA = {
  general:{companyName:'Dystinta', slogan:'Serigrafía, DTF Textil y DTF UV', whatsapp:'+595 982 317 317', whatsappRaw:'595982317317', instagram:'https://www.instagram.com/dys.tintapy/', facebook:'https://www.facebook.com/sshirleybittar/', tiktok:'', email:'', address:'Asunción, Paraguay', map:'https://www.google.com/maps?q=Asuncion+Paraguay&output=embed'},
...
function applyCommon(){initStorage(); renderSharedFooter(); const data=getData(); data.general.whatsapp='+595 982 317 317'; data.general.whatsappRaw='595982317317'; data.general.instagram='https://www.instagram.com/dys.tintapy/'; data.general.facebook='https://www.facebook.com/sshirleybittar/'; saveData(data); document.querySelectorAll('[data-company]').forEach(el=>el.textContent=data.general.companyName); document.querySelectorAll('[data-slogan]').forEach(el=>el.textContent=data.general.slogan); document.querySelectorAll('[data-whatsapp-link]').forEach(el=>el.href='https://wa.me/'+data.general.whatsappRaw); document.querySelectorAll('[data-instagram-link]').forEach(el=>el.href=data.general.instagram||'#'); document.querySelectorAll('[data-facebook-link]').forEach(el=>el.href=data.general.facebook||'#'); document.querySelectorAll('[data-address]').forEach(el=>el.textContent=data.general.address||''); document.querySelectorAll('[data-home-title]').forEach(el=>el.textContent=data.home.title); document.querySelectorAll('[data-home-subtitle]').forEach(el=>el.textContent=data.home.subtitle); document.querySelectorAll('[data-video-caption="1"]').forEach(el=>el.textContent=data.home.video1); document.querySelectorAll('[data-video-caption="2"]').forEach(el=>el.textContent=data.home.video2); document.querySelectorAll('[data-video-caption="3"]').forEach(el=>el.textContent=data.home.video3); const map=document.querySelector('[data-map]'); if(map) map.src=data.general.map||'';}
